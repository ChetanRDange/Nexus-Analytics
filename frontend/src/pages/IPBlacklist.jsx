...
const comapnyInfo = [
  {
    ...
    repeatedapimisuse: "50 failed API requests",
    ddosattackdetection: "3000 requests in 1 minute",
    repeatedlysubmitsincorrectforms: 8,
    suspiciousloginlocations: "Login from Russia and Brazil",
    dateaddednew: "10/08/2024, 2:00 AM",
    addedbynew: "Admin",
  },
  {
    id: 1,
