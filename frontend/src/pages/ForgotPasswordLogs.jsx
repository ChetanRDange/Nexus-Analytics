...
const APILogs = () => {
  ...
  const tableMetaData = {
    tableName: "forgotPassLogs",
    model: "Forgot Password Logs",
    endpoint: "/private/logs/forgotPass",
    viewPath: "api-logs/view",
    showDeleteAll: true,
    deleteField: "type",
  };
      ...
      <div className=" w-full">
        {!fullScreen && (
          <div className="w-full flex justify-between pb-5 border-b border-primary ">
            <div className="">
              <h4 className="text-3xl text-dark">Forgot password Logs</h4>
            </div>
          </div>
        )}
