        ...
        {row.status === "Success" ? (
          <>
            <div className="w-full justify-center items-center mt-8 mb-5 pb-8 border-b border-primary gap-y-4 gap-2  lg:items-start md:items-end xl:items-end">
              <div className="w-full flex flex-col gap-y-4 md:flex-row lg:flex-col xl:flex-row justify-evenly">
                <div className="w-full md:w-[290px] lg:w-[340px] xl:w-[380px]">
                ...
                <div className="w-full">
                  ...
                  <div className="flex gap-4 gap-y-3 justify-start gap-x-10 mb-4 flex-col sm:flex-row sm:items-center">
                    <div className="w-[250px] flex flex-col gap-y-1 mb-4 sm:mb-0">
                      <label className="text-primary font-bold">
                        Login Date & Time
                      </label>
                  ...
                  <div className="flex gap-4 gap-y-3 justify-start gap-x-10 flex-col sm:flex-row sm:items-center">
                    <div className="w-[250px] flex flex-col gap-y-1">
                      <label className="text-primary font-bold">
                        IP Address
                      </label>
                      <a
            ...
            <div className="w-full justify-center items-center mt-8 mb-5 pb-8 gap-y-4 gap-2 lg:items-start md:items-end xl:items-end">
              <div className="w-full flex gap-y-4 gap-x-2 responsiveee justify-evenly">
                <div className="w-full md:w-7/12 2xl:w-[380px]">
                  <span className=" text-primary mb-2 whitespace-nowrap md:whitespace-wrap">
                    Activity Logged
                  </span>
                </div>
          ...
          <>
            <div className="w-full justify-center items-center mt-8 mb-5 pb-8 gap-y-4 gap-2  lg:items-start md:items-end xl:items-end">
              <div className="w-full sm:w-[85%] md:w-[95%] lg:w-[90%] xl:w-[74%] 2xl:w-[60%] flex flex-col gap-y-2 md:flex-row justify-evenly">
...
export default MagicLogsDetails;
